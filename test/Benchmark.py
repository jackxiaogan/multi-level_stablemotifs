...
##        else:
        ...
        u = Simulation.simulate_attractor(z1,samplesize=100,Tsteps=50,Ttrans=300,Tsearch=1000,istates=[])
        w = Simulation.show_atr(u)
##        u = Simulation.simulate_attractor(z1,samplesize=200,Tsteps=50,Ttrans=800,Tsearch=1000,istates=[])
##        w = []
