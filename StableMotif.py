...
##    print '-------------------------'
##    print
    v = functions.nodescan(reducedlist,mode=0)
##    print 'v:',v
...
##        print x
    ...
    ##        function = Booleanops.transform(function)  # transform using qm to the required form
            function = MultiQM.qm(words,v[0],v[1])
##            print "'{}* = {}',".format(node,function)
##            print 'words & function: <{}>, <{}>'.format(words,function), v[0],v[1]
...
##                print 'modified:',reducedlist,functionlist
            ...
            #find each implicant
                ...
                implicants = [ item.strip() for item in implicants]    # stirp each item in the list implicants
                ...
                for j in range (0,implicantscount):
                    ...
                    inputs = [ item.strip() for item in inputs]    # strip each item in the list input
                    # ######## May be unneccesary ######  check if a composite node has already been included but in a different string, e.g. 'A and B' reappearing as 'B and A'
                    for existingnode in ExpandedG.nodes():
                        #compare implicant[j] with existingnode, if implicant[j] is a composite node
                        if (inputs == functions.findinputsstr(existingnode)) and (implicants[j]!=existingnode):
    ##                        print existingnode
    ##                        print implicants[j]
                            implicants[j] = existingnode
        ##                    print implicants[j]
                    # ##############
            ##        print "{} inputs in implicant #{}:".format(inputs,j+1)+ repr(inputs)
            ##        print inputs
                    if inputscount>=2: # adds edges when the implicant is a composite node
                        ExpandedG.add_nodes_from(inputs)
                        for item in inputs:
                            ExpandedG.add_edge(item,implicants[j])

                    ExpandedG.add_node(implicants[j])
        ##            print implicants[j]
                for item in implicants:
                    ExpandedG.add_edge(item,node)
        ##        print " - node function:" + repr(function)
        ##        print "{} implicants:".format(implicantscount)+ repr(implicants)
                # each input should be a node (may be with spaces), and cannot be a phrase. (Not sure if correct)
...
##        print item
    ...
    SMcandidates = functions.candidate(cycles)
...
##    y=['N0$0* =(N12$0 AND N4$0) OR (N12$0 AND N4$1) OR (N12$1 AND N4$0)', 'N0$1* =(N12$1 AND N4$1)', 'N1$0* =(N11$0 AND N12$1) OR (N11$1 AND N12$1)', 'N1$1* =(N11$0 AND N12$0) OR (N11$1 AND N12$0)', 'N2$0* =(N6$0 AND N0$1) OR (N6$1 AND N0$0)', 'N2$1* =(N6$0 AND N0$0) OR (N6$1 AND N0$1)', 'N3$0* =(N13$1 AND N1$0)', 'N3$1* =(N13$0 AND N1$0) OR (N13$0 AND N1$1) OR (N13$1 AND N1$1)', 'N4$0* =(N7$1 AND N0$0)', 'N4$1* =(N7$0 AND N0$0) OR (N7$0 AND N0$1) OR (N7$1 AND N0$1)', 'N5$0* =(N4$0 AND N11$1) OR (N4$1 AND N11$0) OR (N4$1 AND N11$1)', 'N5$1* =(N4$0 AND N11$0)', 'N6$0* =(N9$0 AND N13$0)', 'N6$1* =(N9$0 AND N13$1) OR (N9$1 AND N13$0) OR (N9$1 AND N13$1)', 'N7$0* =(N10$0 AND N3$0) OR (N10$1 AND N3$1)', 'N7$1* =(N10$0 AND N3$1) OR (N10$1 AND N3$0)', 'N8$0* =(N7$0 AND N2$0) OR (N7$0 AND N2$1) OR (N7$1 AND N2$1)', 'N8$1* =(N7$1 AND N2$0)', 'N9$0* =(N12$1 AND N4$0)', 'N9$1* =(N12$0 AND N4$0) OR (N12$0 AND N4$1) OR (N12$1 AND N4$1)', 'N10$0* =(N0$0 AND N1$0) OR (N0$0 AND N1$1) OR (N0$1 AND N1$0)', 'N10$1* =(N0$1 AND N1$1)', 'N11$0* =(N1$0 AND N7$0) OR (N1$0 AND N7$1) OR (N1$1 AND N7$0)', 'N11$1* =(N1$1 AND N7$1)', 'N12$0* =(N14$0 AND N5$1) OR (N14$1 AND N5$0)', 'N12$1* =(N14$0 AND N5$0) OR (N14$1 AND N5$1)', 'N13$0* =(N8$0 AND N14$1)', 'N13$1* =(N8$0 AND N14$0) OR (N8$1 AND N14$0) OR (N8$1 AND N14$1)', 'N14$0* =(N11$1 AND N13$0) OR (N11$1 AND N13$1)', 'N14$1* =(N11$0 AND N13$0) OR (N11$0 AND N13$1)']
    y = ['N0$0* =(N4$0 AND N3$1) OR (N4$1 AND N3$1)', 'N0$1* =(N4$0 AND N3$0) OR (N4$1 AND N3$0)', 'N1$0* =(N2$0 AND N0$0) OR (N2$1 AND N0$1)', 'N1$1* =(N2$0 AND N0$1) OR (N2$1 AND N0$0)', 'N2$0* =(N4$1 AND N3$0) OR (N4$1 AND N3$1)', 'N2$1* =(N4$0 AND N3$0) OR (N4$0 AND N3$1)', 'N3$0* =(N5$0 AND N1$1) OR (N5$1 AND N1$0) OR (N5$1 AND N1$1)', 'N3$1* =(N5$0 AND N1$0)', 'N4$0* =(N2$0 AND N5$0) OR (N2$1 AND N5$1)', 'N4$1* =(N2$0 AND N5$1) OR (N2$1 AND N5$0)', 'N5$0* =(N2$0 AND N1$1) OR (N2$1 AND N1$1)', 'N5$1* =(N2$0 AND N1$0) OR (N2$1 AND N1$0)']
...
##    y=['N0$0* =(N3$0 AND N2$1) OR (N3$1 AND N2$1)', 'N0$1* =(N3$0 AND N2$0)', 'N0$2* =(N3$1 AND N2$0)', 'N1$0* =(N2$0 AND N3$0) OR (N2$0 AND N3$1) OR (N2$1 AND N3$1)', 'N1$1* =(N2$1 AND N3$0)', 'N2$0* =(N1$0 AND N4$0) OR (N1$0 AND N4$1) OR (N1$1 AND N4$0)', 'N2$1* =(N1$1 AND N4$1)', 'N3$0* =(N4$0 AND N0$0) OR (N4$0 AND N0$2) OR (N4$1 AND N0$2)', 'N3$1* =(N4$0 AND N0$1) OR (N4$1 AND N0$0) OR (N4$1 AND N0$1)', 'N4$0* =(N2$0 AND N1$0) OR (N2$0 AND N1$1) OR (N2$1 AND N1$1)', 'N4$1* =(N2$1 AND N1$0)']
##    y = ['N0$0* =(N8$0 AND N2$1) OR (N8$0 AND N2$2)', 'N0$1* =(N8$0 AND N2$0) OR (N8$1 AND N2$0) OR (N8$1 AND N2$1) OR (N8$1 AND N2$2) OR (N8$2 AND N2$1) OR (N8$2 AND N2$2)', 'N0$2* =(N8$2 AND N2$0)', 'N1$0* =(N6$1 AND N9$1)', 'N1$1* =(N6$0 AND N9$0) OR (N6$1 AND N9$0) OR (N6$2 AND N9$2)', 'N1$2* =(N6$0 AND N9$1) OR (N6$0 AND N9$2) OR (N6$1 AND N9$2) OR (N6$2 AND N9$0) OR (N6$2 AND N9$1)', 'N2$0* =(N8$0 AND N3$0) OR (N8$0 AND N3$2) OR (N8$1 AND N3$0) OR (N8$1 AND N3$1) OR (N8$2 AND N3$2)', 'N2$1* =(N8$0 AND N3$1) OR (N8$1 AND N3$2)', 'N2$2* =(N8$2 AND N3$0) OR (N8$2 AND N3$1)', 'N3$0* =(N6$0 AND N0$0)', 'N3$1* =(N6$1 AND N0$0) OR (N6$1 AND N0$1) OR (N6$2 AND N0$1) OR (N6$2 AND N0$2)', 'N3$2* =(N6$0 AND N0$1) OR (N6$0 AND N0$2) OR (N6$1 AND N0$2) OR (N6$2 AND N0$0)', 'N4$0* =(N5$1 AND N7$0) OR (N5$1 AND N7$2) OR (N5$2 AND N7$2)', 'N4$1* =(N5$0 AND N7$0) OR (N5$0 AND N7$1) OR (N5$0 AND N7$2) OR (N5$1 AND N7$1) OR (N5$2 AND N7$0) OR (N5$2 AND N7$1)', 'N5$0* =(N2$1 AND N3$2)', 'N5$1* =(N2$0 AND N3$1) OR (N2$1 AND N3$0) OR (N2$1 AND N3$1) OR (N2$2 AND N3$2)', 'N5$2* =(N2$0 AND N3$0) OR (N2$0 AND N3$2) OR (N2$2 AND N3$0) OR (N2$2 AND N3$1)', 'N6$0* =(N3$0 AND N5$1) OR (N3$1 AND N5$0) OR (N3$2 AND N5$0) OR (N3$2 AND N5$1)', 'N6$1* =(N3$0 AND N5$0) OR (N3$1 AND N5$2)', 'N6$2* =(N3$0 AND N5$2) OR (N3$1 AND N5$1) OR (N3$2 AND N5$2)', 'N7$0* =(N3$0 AND N1$2) OR (N3$2 AND N1$0) OR (N3$2 AND N1$1)', 'N7$1* =(N3$0 AND N1$1)', 'N7$2* =(N3$0 AND N1$0) OR (N3$1 AND N1$0) OR (N3$1 AND N1$1) OR (N3$1 AND N1$2) OR (N3$2 AND N1$2)', 'N8$0* =(N4$0 AND N1$0) OR (N4$0 AND N1$1) OR (N4$1 AND N1$0) OR (N4$1 AND N1$2)', 'N8$1* =(N4$1 AND N1$1)', 'N8$2* =(N4$0 AND N1$2)', 'N9$0* =(N3$0 AND N4$0) OR (N3$1 AND N4$1) OR (N3$2 AND N4$0) OR (N3$2 AND N4$1)', 'N9$1* =(N3$0 AND N4$1)', 'N9$2* =(N3$1 AND N4$0)']
##    y=['N0$0* =(N3$0 AND N1$0) OR (N3$0 AND N1$2) OR (N3$1 AND N1$0) OR (N3$1 AND N1$2)', 'N0$1* =(N3$0 AND N1$1) OR (N3$1 AND N1$1)', 'N1$0* =(N3$0 AND N0$0) OR (N3$1 AND N0$0)', 'N1$1* =(N3$0 AND N0$1)', 'N1$2* =(N3$1 AND N0$1)', 'N2$0* =(N0$0 AND N3$1) OR (N0$1 AND N3$0)', 'N2$1* =(N0$0 AND N3$0) OR (N0$1 AND N3$1)', 'N3$0* =(N1$0 AND N2$0) OR (N1$1 AND N2$1) OR (N1$2 AND N2$0)', 'N3$1* =(N1$0 AND N2$1) OR (N1$1 AND N2$0) OR (N1$2 AND N2$1)', 'N4$0* =(N1$1 AND N2$0) OR (N1$1 AND N2$1)', 'N4$1* =(N1$0 AND N2$0) OR (N1$0 AND N2$1) OR (N1$2 AND N2$1)', 'N4$2* =(N1$2 AND N2$0)']

##    y = ['N0$0* =(N4$0 AND N3$1) OR (N4$1 AND N3$0) OR (N4$1 AND N3$1)', 'N0$1* =(N4$0 AND N3$0)', 'N1$0* =(N0$0 AND N2$0) OR (N0$0 AND N2$1)', 'N1$1* =(N0$0 AND N2$2) OR (N0$1 AND N2$1)', 'N1$2* =(N0$1 AND N2$0) OR (N0$1 AND N2$2)', 'N2$0* =(N1$0 AND N0$1) OR (N1$1 AND N0$0) OR (N1$1 AND N0$1) OR (N1$2 AND N0$1)', 'N2$1* =(N1$2 AND N0$0)', 'N2$2* =(N1$0 AND N0$0)', 'N3$0* =(N1$0 AND N0$0) OR (N1$1 AND N0$0) OR (N1$2 AND N0$1)', 'N3$1* =(N1$0 AND N0$1) OR (N1$1 AND N0$1) OR (N1$2 AND N0$0)', 'N4$0* =(N0$1 AND N3$0)', 'N4$1* =(N0$0 AND N3$0) OR (N0$0 AND N3$1) OR (N0$1 AND N3$1)', 'N5$0* =(N3$1 AND N1$0) OR (N3$1 AND N1$1)', 'N5$1* =(N3$0 AND N1$0) OR (N3$0 AND N1$1) OR (N3$0 AND N1$2) OR (N3$1 AND N1$2)']
##    y= ['N0$0* =(N4$0 AND N3$1) OR (N4$1 AND N3$1)', 'N0$1* =(N4$0 AND N3$0) OR (N4$1 AND N3$0)', 'N1$0* =(N2$0 AND N0$0) OR (N2$1 AND N0$1)', 'N1$1* =(N2$0 AND N0$1) OR (N2$1 AND N0$0)', 'N2$0* =(N4$1 AND N3$0) OR (N4$1 AND N3$1)', 'N2$1* =(N4$0 AND N3$0) OR (N4$0 AND N3$1)', 'N3$0* =(N5$0 AND N1$1) OR (N5$1 AND N1$0) OR (N5$1 AND N1$1)', 'N3$1* =(N5$0 AND N1$0)', 'N4$0* =(N2$0 AND N5$0) OR (N2$1 AND N5$1)', 'N4$1* =(N2$0 AND N5$1) OR (N2$1 AND N5$0)', 'N5$0* =(N2$0 AND N1$1) OR (N2$1 AND N1$1)', 'N5$1* =(N2$0 AND N1$0) OR (N2$1 AND N1$0)']
